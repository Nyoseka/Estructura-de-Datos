...
namespace P14.PilaNumerosFlotantes
{
    class Program
    {
        public class Pilas
        ...
        static void Main(string[] args)
        {
            ...
            void Menu()
            {
                Console.WriteLine("MENU PILA DE NUMEROS" + '\n');
                Console.WriteLine("    -----    ");
                    ...
                    case 2: opcion = 2;
                        {
                            ...
                            element = float.Parse(Console.ReadLine());
                            pila.Push(element);
                    ...
                    case 5: opcion = 5;
                        {
                            ...
                            ebusqueda = float.Parse(Console.ReadLine());
