        ...
        public class Arbol
        {
            ...
            public void Insertar(string dato)
            {
                ...
                else
                {
                    ...
                    while (bandera != 1)
                    {
                        if (string.Compare(hoja.info,temp.info)==-1)
                        {
            ...
            public void BusquedaRecursiva(string key, Arbol temp)
            {
                if (temp == null)
                {
                ...
                else
                {
                    ...
                    {
                        if (string.Compare(key,temp.info)==-1)
                        {
            ...
            public void BusquedaIterativa(string key, Arbol temp)
            {
            ...
            public void Eliminar()
            {
                ...
                if (p != null)
                {
                    ...
                    while (p != null & encontrado == false)
                    {
                        ...
                        {
                            q = p;
                            if (string.Compare(x,p.info)==-1)//string.Compare <0
                            {
                                p = p.izquierdo;
                            }
                            else
